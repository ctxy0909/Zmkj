...
{
    private final static List<Tests> testList = new ArrayList<>();
    {
        testList.add(new Tests("1", "admin", "admin123"));
        testList.add(new Tests("2", "ry", "admin123"));
    }

    @ApiOperation("获取列表")
    @GetMapping("list")
    public List<Tests> testList()
    {
        return testList;
    }
    ...
    @ApiOperation("新增用户")
    @PostMapping("save")
    public AjaxResult save(Tests test)
    {
    ...
    @PutMapping("update")
    public AjaxResult update(Tests test)
    {
    ...
    public AjaxResult delete(Tests test)
    {
...
class Tests
{
    ...
    public Tests(String userId, String username, String password)
    {
        this.userId = userId;
